import { c as createComponent, m as maybeRenderHead, i as renderComponent, r as renderTemplate } from '../chunks/astro/server_CD0p8EJo.mjs';
import 'kleur/colors';
/* empty css                                 */
...
const $$Properties = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<main class="container my-5"> <h1 class="mb-4 text-center">Inmuebles disponibles</h1> ${renderComponent($$result, "InmuebleList", InmuebleList, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/Desktop/prueba tecnica/inmobiliaria/src/components/InmuebleList.vue", "client:component-export": "default" })} </main>`;
