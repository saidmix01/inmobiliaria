import { c as createComponent, d as createAstro, r as renderTemplate, a as renderComponent, b as renderHead } from '../../chunks/astro/server_AN8NM7U5.mjs';
import 'kleur/colors';
/* empty css                                    */
/* empty css                                    */
...
const $$id = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><title>Aplicar oferta</title><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" defer><\/script>', '</head> <body> <main class="container my-5"> ', " </main> </body></html>"])), renderHead(), renderComponent($$result, "OfferForm", OfferForm, { ":propertyId": "`${id}`", "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/Desktop/prueba tecnica/inmobiliaria/src/components/OfferForm.vue", "client:component-export": "default" }));
